                    ...
                    foreach ($document_type_fields as $field) {
                        ...
                        switch ($field_type) {
                            ...
                            case 'cascading_dropdown':
                                // This will be handled by JS, just render the hidden input for initial value
                                echo '<input type="hidden" id="metadata_' . $field_name . '_data" name="metadata[' . $field_name . ']" value="' . htmlspecialchars($current_value) . '" ' . $requiredAttr . '>';
                                // Need to render the actual dropdowns for JS to populate
                                echo generateCascadingDropdownHTML($field_name, $requiredAttr);
                                break;
                ...
                .then(data => {
                    if (data.success && data.fields) {
                        data.fields.forEach(field => {
                            ...
                            const currentValue = documentMetadata[fieldName] ? documentMetadata[fieldName].value : '';
