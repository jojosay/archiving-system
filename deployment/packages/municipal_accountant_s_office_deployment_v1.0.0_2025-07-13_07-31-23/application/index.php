...
$protected_pages = ['dashboard', 'user_register', 'user_list', 'document_types', 'document_fields', 'location_management', 'book_images', 'document_upload', 'document_archive', 'document_edit', 'backup_management', 'system_reset', 'reports', 'branding_management', 'deployment_center', 'package_builder', 'about'];
